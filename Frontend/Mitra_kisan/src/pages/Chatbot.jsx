...
const Chatbot = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      let errorMessage = "Error: " + (err.message || "Unknown error");
      if (err.message && err.message.includes("Missing backend Google API key")) {
        errorMessage = "Chatbot is not available. Please set GOOGLE_API_KEY in Backend/.env to enable AI chat.";
      }
      setChatHistory((prev) => [
        ...prev,
